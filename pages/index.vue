...
import FButton from '../components/shared/FButton.vue';
import FTypographi from '../components/shared/FTypographi.vue';
import FCard from '../components/shared/FCard.vue';
</script>

<template>
  <div class="container">
    <FCard class="p-5 w-1/2">
